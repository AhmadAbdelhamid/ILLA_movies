...
package com.example.illa_movies.databinding;
...
public final class MainActivityBinding implements ViewBinding {
  ...
  private MainActivityBinding(@NonNull ConstraintLayout rootView,
      @NonNull FragmentContainerView navHostFragment, @NonNull BottomNavigationView navView) {
  ...
  public static MainActivityBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new MainActivityBinding((ConstraintLayout) rootView, navHostFragment, navView);
    }
